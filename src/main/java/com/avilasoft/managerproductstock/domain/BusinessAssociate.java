...
public class BusinessAssociate implements Serializable {
    ...
    public BusinessAssociate descrption(String descrption) {
    ...
    public BusinessAssociate email(String email) {
        this.setEmail(email);
        return this;
    }
    ...
    public BusinessAssociate addressLine1(String addressLine1) {
    ...
    public BusinessAssociate addressLine2(String addressLine2) {
    ...
    public BusinessAssociate city(String city) {
        this.setCity(city);
        return this;
    }
    ...
    public BusinessAssociate country(String country) {
    ...
    public void setBatches(Set<Batch> batches) {
        if (this.batches != null) {
            this.batches.forEach(i -> i.setBusinessAssociate(null));
        }
        if (batches != null) {
            batches.forEach(i -> i.setBusinessAssociate(this));
        }
        this.batches = batches;
    }

    public BusinessAssociate batches(Set<Batch> batches) {
        this.setBatches(batches);
        return this;
    }

    public BusinessAssociate addBatch(Batch batch) {
        this.batches.add(batch);
        batch.setBusinessAssociate(this);
        return this;
    }

    public BusinessAssociate removeBatch(Batch batch) {
        this.batches.remove(batch);
        batch.setBusinessAssociate(null);
        return this;
    }
