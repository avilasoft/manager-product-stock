...
public class ComputedPriceListItem implements Serializable {
    ...
    @NotNull
    @Column(name = "computed_price_total", nullable = false)
    private Float computedPriceTotal;
    ...
    public Float getComputedPriceTotal() {
        return this.computedPriceTotal;
    }

    public ComputedPriceListItem computedPriceTotal(Float computedPriceTotal) {
        this.setComputedPriceTotal(computedPriceTotal);
        return this;
    }

    public void setComputedPriceTotal(Float computedPriceTotal) {
        this.computedPriceTotal = computedPriceTotal;
    }
    ...
    public ComputedPriceListItem description(String description) {
    ...
    public String toString() {
        return "ComputedPriceListItem{" +
            "id=" + getId() +
            ", code='" + getCode() + "'" +
            ", computedPriceTotal=" + getComputedPriceTotal() +
