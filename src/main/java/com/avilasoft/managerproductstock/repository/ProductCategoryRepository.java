...
public interface ProductCategoryRepository extends JpaRepository<ProductCategory, Long> {
    ...
    @Query(
        value = "select distinct productCategory from ProductCategory productCategory left join fetch productCategory.category",
    ...
    @Query("select distinct productCategory from ProductCategory productCategory left join fetch productCategory.category")
    List<ProductCategory> findAllWithToOneRelationships();

    @Query(
        "select productCategory from ProductCategory productCategory left join fetch productCategory.category where productCategory.id =:id"
    )
