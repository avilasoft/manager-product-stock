    ...
    public Optional<BusinessAssociate> partialUpdate(BusinessAssociate businessAssociate) {
        ...
        return businessAssociateRepository
            ...
            .map(existingBusinessAssociate -> {
                ...
                if (businessAssociate.getDescrption() != null) {
                    existingBusinessAssociate.setDescrption(businessAssociate.getDescrption());
                }
                if (businessAssociate.getEmail() != null) {
                    existingBusinessAssociate.setEmail(businessAssociate.getEmail());
                }
                if (businessAssociate.getPhone() != null) {
                    existingBusinessAssociate.setPhone(businessAssociate.getPhone());
                }
                if (businessAssociate.getAddressLine1() != null) {
                    existingBusinessAssociate.setAddressLine1(businessAssociate.getAddressLine1());
                }
                if (businessAssociate.getAddressLine2() != null) {
                    existingBusinessAssociate.setAddressLine2(businessAssociate.getAddressLine2());
                }
                if (businessAssociate.getCity() != null) {
                    existingBusinessAssociate.setCity(businessAssociate.getCity());
                }
                if (businessAssociate.getCountry() != null) {
                    existingBusinessAssociate.setCountry(businessAssociate.getCountry());
                }
