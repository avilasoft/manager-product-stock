    ...
    public Optional<ComputedPriceListItem> partialUpdate(ComputedPriceListItem computedPriceListItem) {
        ...
        return computedPriceListItemRepository
            ...
            .map(existingComputedPriceListItem -> {
                ...
                if (computedPriceListItem.getName() != null) {
                    existingComputedPriceListItem.setName(computedPriceListItem.getName());
                }
                if (computedPriceListItem.getComputedCostTotal() != null) {
                    existingComputedPriceListItem.setComputedCostTotal(computedPriceListItem.getComputedCostTotal());
                }
