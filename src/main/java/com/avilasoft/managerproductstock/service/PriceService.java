...
public class PriceService {
    ...
    /**
     * Get all the prices with eager load of many-to-many relationships.
     *
     * @return the list of entities.
     */
    public Page<Price> findAllWithEagerRelationships(Pageable pageable) {
        return priceRepository.findAllWithEagerRelationships(pageable);
    }
    ...
    public Optional<Price> findOne(Long id) {
        ...
        return priceRepository.findOneWithEagerRelationships(id);
    }
