    ...
    public Optional<ProviderProductPrice> partialUpdate(ProviderProductPrice providerProductPrice) {
        ...
        return providerProductPriceRepository
            ...
            .map(existingProviderProductPrice -> {
                if (providerProductPrice.getName() != null) {
                    existingProviderProductPrice.setName(providerProductPrice.getName());
                }
                if (providerProductPrice.getValue() != null) {
                    existingProviderProductPrice.setValue(providerProductPrice.getValue());
                }
