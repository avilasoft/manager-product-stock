...
import com.avilasoft.managerproductstock.service.BatchService;
...
/**
 * REST controller for managing {@link com.avilasoft.managerproductstock.domain.Batch}.
 */
@RestController
@RequestMapping("/api")
public class BatchResource {
    ...
    public ResponseEntity<List<Batch>> getAllBatches(
        ...
        Page<Batch> page;
        if (eagerload) {
            page = batchService.findAllWithEagerRelationships(pageable);
        } else {
            page = batchService.findAll(pageable);
        }
