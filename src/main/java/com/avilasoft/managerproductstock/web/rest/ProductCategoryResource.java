...
import com.avilasoft.managerproductstock.repository.ProductCategoryRepository;
import com.avilasoft.managerproductstock.service.ProductCategoryService;
...
/**
 * REST controller for managing {@link com.avilasoft.managerproductstock.domain.ProductCategory}.
 */
@RestController
@RequestMapping("/api")
public class ProductCategoryResource {
    ...
    public ResponseEntity<List<ProductCategory>> getAllProductCategories(
        ...
        if (eagerload) {
            page = productCategoryService.findAllWithEagerRelationships(pageable);
        } else {
            page = productCategoryService.findAll(pageable);
        }
