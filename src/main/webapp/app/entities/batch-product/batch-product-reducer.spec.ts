...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BATCHPRODUCT_LIST actions', async () => {
    ...
    it('dispatches FETCH_BATCHPRODUCT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BATCHPRODUCT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BATCHPRODUCT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BATCHPRODUCT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BATCHPRODUCT actions', async () => {
      const expectedActions = [
        {
