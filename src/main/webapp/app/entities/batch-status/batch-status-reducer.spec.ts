...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BATCHSTATUS_LIST actions', async () => {
    ...
    it('dispatches FETCH_BATCHSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BATCHSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BATCHSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BATCHSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BATCHSTATUS actions', async () => {
      const expectedActions = [
        {
