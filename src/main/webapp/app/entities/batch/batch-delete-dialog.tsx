...
export const BatchDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="managerProductStockApp.batch.delete.question">
        <Translate contentKey="managerProductStockApp.batch.delete.question" interpolate={{ id: batchEntity.id }}>
