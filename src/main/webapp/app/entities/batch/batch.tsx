          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="managerProductStockApp.batch.batchProduct">Batch Product</Translate>{' '}
                  <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            ...
            <tbody>
              {batchList.map((batch, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{batch.batchProduct ? <Link to={`batch-product/${batch.batchProduct.id}`}>{batch.batchProduct.name}</Link> : ''}</td>
