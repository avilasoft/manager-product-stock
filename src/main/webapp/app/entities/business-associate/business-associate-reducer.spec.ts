...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './business-associate.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BUSINESSASSOCIATE_LIST actions', async () => {
    ...
    it('dispatches FETCH_BUSINESSASSOCIATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BUSINESSASSOCIATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BUSINESSASSOCIATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BUSINESSASSOCIATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BUSINESSASSOCIATE actions', async () => {
      const expectedActions = [
        {
