        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              />
              <ValidatedField
                label={translate('managerProductStockApp.businessAssociate.descrption')}
                id="business-associate-descrption"
                name="descrption"
                data-cy="descrption"
                type="text"
                validate={{
              ...
              />
              <ValidatedField
                label={translate('managerProductStockApp.businessAssociate.email')}
                id="business-associate-email"
                name="email"
                data-cy="email"
                type="text"
                validate={{
              ...
              />
              <ValidatedField
                label={translate('managerProductStockApp.businessAssociate.addressLine1')}
                id="business-associate-addressLine1"
                name="addressLine1"
              ...
              />
              <ValidatedField
                label={translate('managerProductStockApp.businessAssociate.addressLine2')}
                id="business-associate-addressLine2"
                name="addressLine2"
                data-cy="addressLine2"
                type="text"
              />
              <ValidatedField
                label={translate('managerProductStockApp.businessAssociate.city')}
                id="business-associate-city"
                name="city"
                data-cy="city"
                type="text"
                validate={{
              ...
              />
              <ValidatedField
                label={translate('managerProductStockApp.businessAssociate.country')}
                id="business-associate-country"
                name="country"
                data-cy="country"
                type="text"
                validate={{
