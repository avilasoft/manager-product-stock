        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('managerProductStockApp.businessAssociate.nickname')}
                id="business-associate-nickname"
                name="nickname"
                data-cy="nickname"
                type="text"
                validate={{
              ...
              />
              <ValidatedField
                label={translate('managerProductStockApp.businessAssociate.name')}
              ...
              />
              <ValidatedField
                label={translate('managerProductStockApp.businessAssociate.lastname')}
                id="business-associate-lastname"
                name="lastname"
                data-cy="lastname"
                type="text"
                validate={{
              ...
              />
              <ValidatedField
                label={translate('managerProductStockApp.businessAssociate.phone')}
                id="business-associate-phone"
                name="phone"
                data-cy="phone"
                type="text"
              />
