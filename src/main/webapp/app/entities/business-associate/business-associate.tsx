          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('comercialName')}>
                  <Translate contentKey="managerProductStockApp.businessAssociate.comercialName">Comercial Name</Translate>{' '}
                  <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('description')}>
                  <Translate contentKey="managerProductStockApp.businessAssociate.description">Description</Translate>{' '}
                  <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('type')}>
                  <Translate contentKey="managerProductStockApp.businessAssociate.type">Type</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
            ...
            <tbody>
              {businessAssociateList.map((businessAssociate, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{businessAssociate.comercialName}</td>
                  <td>{businessAssociate.description}</td>
                  <td>
                    <Translate contentKey={`managerProductStockApp.BusinessAssociateType.${businessAssociate.type}`} />
                  </td>
