...
export const CategoryDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="managerProductStockApp.category.delete.question">
        <Translate contentKey="managerProductStockApp.category.delete.question" interpolate={{ id: categoryEntity.id }}>
