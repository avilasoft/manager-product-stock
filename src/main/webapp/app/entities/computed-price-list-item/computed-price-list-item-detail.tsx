    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="name">
              <Translate contentKey="managerProductStockApp.computedPriceListItem.name">Name</Translate>
            </span>
          </dt>
          <dd>{computedPriceListItemEntity.name}</dd>
          <dt>
            <span id="computedCostTotal">
              <Translate contentKey="managerProductStockApp.computedPriceListItem.computedCostTotal">Computed Cost Total</Translate>
            </span>
          </dt>
          <dd>{computedPriceListItemEntity.computedCostTotal}</dd>
          <dt>
          ...
          <dd>{computedPriceListItemEntity.unitPriceList ? computedPriceListItemEntity.unitPriceList.code : ''}</dd>
          <dt>
            <Translate contentKey="managerProductStockApp.computedPriceListItem.computedPriceList">Computed Price List</Translate>
          </dt>
          <dd>{computedPriceListItemEntity.computedPriceList ? computedPriceListItemEntity.computedPriceList.code : ''}</dd>
        </dl>
