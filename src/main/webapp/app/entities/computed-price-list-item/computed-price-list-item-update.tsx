        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              />
              <ValidatedField
                label={translate('managerProductStockApp.computedPriceListItem.computedPriceTotal')}
                id="computed-price-list-item-computedPriceTotal"
                name="computedPriceTotal"
                data-cy="computedPriceTotal"
                type="text"
                validate={{
                  required: { value: true, message: translate('entity.validation.required') },
              ...
              />
              <ValidatedField
                label={translate('managerProductStockApp.computedPriceListItem.description')}
                id="computed-price-list-item-description"
                name="description"
                data-cy="description"
                type="text"
              />
