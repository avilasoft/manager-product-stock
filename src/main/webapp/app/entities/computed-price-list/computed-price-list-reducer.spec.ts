...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './computed-price-list.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMPUTEDPRICELIST_LIST actions', async () => {
    ...
    it('dispatches FETCH_COMPUTEDPRICELIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COMPUTEDPRICELIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COMPUTEDPRICELIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COMPUTEDPRICELIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COMPUTEDPRICELIST actions', async () => {
      const expectedActions = [
        {
