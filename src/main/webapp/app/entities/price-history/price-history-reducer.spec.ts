...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './price-history.reducer';
import { EntityState } from 'app/shared/reducers/reducer.utils';
import { IPriceHistory, defaultValue } from 'app/shared/model/price-history.model';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRICEHISTORY_LIST actions', async () => {
    ...
    it('dispatches FETCH_PRICEHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PRICEHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PRICEHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PRICEHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PRICEHISTORY actions', async () => {
      const expectedActions = [
        {
