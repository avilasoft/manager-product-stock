...
export const ProductCategoryDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="managerProductStockApp.productCategory.delete.question">
        <Translate contentKey="managerProductStockApp.productCategory.delete.question" interpolate={{ id: productCategoryEntity.id }}>
