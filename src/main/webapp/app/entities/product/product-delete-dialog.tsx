...
export const ProductDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="managerProductStockApp.product.delete.question">
        <Translate contentKey="managerProductStockApp.product.delete.question" interpolate={{ id: productEntity.id }}>
