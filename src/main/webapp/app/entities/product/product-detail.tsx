    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="managerProductStockApp.product.unit">Unit</Translate>
          </dt>
          <dd>{productEntity.unit ? productEntity.unit.name : ''}</dd>
          <dt>
            <Translate contentKey="managerProductStockApp.product.providerProduct">Provider Product</Translate>
          </dt>
          <dd>{productEntity.providerProduct ? productEntity.providerProduct.name : ''}</dd>
          <dt>
