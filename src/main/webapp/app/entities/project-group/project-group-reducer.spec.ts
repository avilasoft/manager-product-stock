...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROJECTGROUP_LIST actions', async () => {
    ...
    it('dispatches FETCH_PROJECTGROUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PROJECTGROUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PROJECTGROUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PROJECTGROUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PROJECTGROUP actions', async () => {
      const expectedActions = [
        {
