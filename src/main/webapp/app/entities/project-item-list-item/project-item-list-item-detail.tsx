    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="name">
              <Translate contentKey="managerProductStockApp.projectItemListItem.name">Name</Translate>
            </span>
          </dt>
          <dd>{projectItemListItemEntity.name}</dd>
          <dt>
            <span id="dimension">
          ...
          <dd>{projectItemListItemEntity.providerItem ? projectItemListItemEntity.providerItem.name : ''}</dd>
          <dt>
