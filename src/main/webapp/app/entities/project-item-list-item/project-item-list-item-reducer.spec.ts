...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './project-item-list-item.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROJECTITEMLISTITEM_LIST actions', async () => {
    ...
    it('dispatches FETCH_PROJECTITEMLISTITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PROJECTITEMLISTITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PROJECTITEMLISTITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PROJECTITEMLISTITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PROJECTITEMLISTITEM actions', async () => {
      const expectedActions = [
        {
