            ...
            <tbody>
              {projectItemListItemList.map((projectItemListItem, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{projectItemListItem.description}</td>
                  <td>
                    {projectItemListItem.unitPriceListItem ? (
                      <Link to={`unit-price-list-item/${projectItemListItem.unitPriceListItem.id}`}>
                        {projectItemListItem.unitPriceListItem.unitPriceTotal}
                      </Link>
                    ) : (
                      ''
                    )}
                  ...
                  <td>
                    {projectItemListItem.providerItem ? (
                      <Link to={`provider-item/${projectItemListItem.providerItem.id}`}>{projectItemListItem.providerItem.code}</Link>
                    ) : (
                      ''
                    )}
                  </td>
