    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dd>{projectItemListEntity.unitPriceList ? projectItemListEntity.unitPriceList.code : ''}</dd>
          <dt>
            <Translate contentKey="managerProductStockApp.projectItemList.computedPriceList">Computed Price List</Translate>
          </dt>
          <dd>{projectItemListEntity.computedPriceList ? projectItemListEntity.computedPriceList.code : ''}</dd>
          <dt>
