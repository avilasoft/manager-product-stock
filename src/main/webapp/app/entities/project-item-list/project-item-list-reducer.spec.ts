...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './project-item-list.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROJECTITEMLIST_LIST actions', async () => {
    ...
    it('dispatches FETCH_PROJECTITEMLIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PROJECTITEMLIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PROJECTITEMLIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PROJECTITEMLIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PROJECTITEMLIST actions', async () => {
      const expectedActions = [
        {
