                ...
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    {projectItemList.unitPriceList ? (
                      <Link to={`unit-price-list/${projectItemList.unitPriceList.id}`}>
                        {projectItemList.unitPriceList.unitPriceListTotal}
                      </Link>
                    ) : (
                      ''
                    )}
                  ...
                  <td>
                    {projectItemList.computedPriceList ? (
                      <Link to={`computed-price-list/${projectItemList.computedPriceList.id}`}>
                        {projectItemList.computedPriceList.computedPriceListTotal}
                      </Link>
                    ) : (
                      ''
                    )}
