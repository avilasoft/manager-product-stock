...
export const ProjectDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="managerProductStockApp.project.delete.question">
        <Translate contentKey="managerProductStockApp.project.delete.question" interpolate={{ id: projectEntity.id }}>
