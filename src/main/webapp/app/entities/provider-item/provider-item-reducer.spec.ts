...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROVIDERITEM_LIST actions', async () => {
    ...
    it('dispatches FETCH_PROVIDERITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PROVIDERITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PROVIDERITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PROVIDERITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PROVIDERITEM actions', async () => {
      const expectedActions = [
        {
