    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="managerProductStockApp.providerProductPrice.unit">Unit</Translate>
          </dt>
          <dd>{providerProductPriceEntity.unit ? providerProductPriceEntity.unit.name : ''}</dd>
        </dl>
