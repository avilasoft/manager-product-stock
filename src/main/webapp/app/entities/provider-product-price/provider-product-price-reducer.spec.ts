...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './provider-product-price.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROVIDERPRODUCTPRICE_LIST actions', async () => {
    ...
    it('dispatches FETCH_PROVIDERPRODUCTPRICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PROVIDERPRODUCTPRICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PROVIDERPRODUCTPRICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PROVIDERPRODUCTPRICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PROVIDERPRODUCTPRICE actions', async () => {
      const expectedActions = [
        {
