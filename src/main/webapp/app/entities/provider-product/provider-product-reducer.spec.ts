...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROVIDERPRODUCT_LIST actions', async () => {
    ...
    it('dispatches FETCH_PROVIDERPRODUCT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PROVIDERPRODUCT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PROVIDERPRODUCT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PROVIDERPRODUCT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PROVIDERPRODUCT actions', async () => {
      const expectedActions = [
        {
