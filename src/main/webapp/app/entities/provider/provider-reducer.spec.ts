...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './provider.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROVIDER_LIST actions', async () => {
    ...
    it('dispatches FETCH_PROVIDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PROVIDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PROVIDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PROVIDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PROVIDER actions', async () => {
      const expectedActions = [
        {
