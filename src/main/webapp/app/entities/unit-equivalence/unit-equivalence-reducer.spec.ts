...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_UNITEQUIVALENCE_LIST actions', async () => {
    ...
    it('dispatches FETCH_UNITEQUIVALENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_UNITEQUIVALENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_UNITEQUIVALENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_UNITEQUIVALENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_UNITEQUIVALENCE actions', async () => {
      const expectedActions = [
        {
