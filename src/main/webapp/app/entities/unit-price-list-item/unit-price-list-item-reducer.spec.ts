...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './unit-price-list-item.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_UNITPRICELISTITEM_LIST actions', async () => {
    ...
    it('dispatches FETCH_UNITPRICELISTITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_UNITPRICELISTITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_UNITPRICELISTITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_UNITPRICELISTITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_UNITPRICELISTITEM actions', async () => {
      const expectedActions = [
        {
