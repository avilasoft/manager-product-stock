        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              />
              <ValidatedField
                label={translate('managerProductStockApp.unitPriceListItem.unitPriceTotal')}
                id="unit-price-list-item-unitPriceTotal"
                name="unitPriceTotal"
                data-cy="unitPriceTotal"
                type="text"
                validate={{
                  required: { value: true, message: translate('entity.validation.required') },
              ...
              />
              <ValidatedField
                label={translate('managerProductStockApp.unitPriceListItem.description')}
                id="unit-price-list-item-description"
                name="description"
                data-cy="description"
                type="text"
              />
