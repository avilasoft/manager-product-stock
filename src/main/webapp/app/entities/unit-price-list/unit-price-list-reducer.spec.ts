...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_UNITPRICELIST_LIST actions', async () => {
    ...
    it('dispatches FETCH_UNITPRICELIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_UNITPRICELIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_UNITPRICELIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_UNITPRICELIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_UNITPRICELIST actions', async () => {
      const expectedActions = [
        {
