...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './unit-type.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_UNITTYPE_LIST actions', async () => {
    ...
    it('dispatches FETCH_UNITTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_UNITTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_UNITTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_UNITTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_UNITTYPE actions', async () => {
      const expectedActions = [
        {
