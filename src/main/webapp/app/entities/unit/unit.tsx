          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('isBase')}>
                  <Translate contentKey="managerProductStockApp.unit.isBase">Is Base</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="managerProductStockApp.unit.unitType">Unit Type</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                ...
                <th>
                  <Translate contentKey="managerProductStockApp.unit.product">Product</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {unitList.map((unit, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{unit.symbol}</td>
                  <td>{unit.isBase ? 'true' : 'false'}</td>
                  <td>{unit.unitType ? <Link to={`unit-type/${unit.unitType.id}`}>{unit.unitType.name}</Link> : ''}</td>
                  <td>
                    {unit.providerProductPrice ? (
                      <Link to={`provider-product-price/${unit.providerProductPrice.id}`}>{unit.providerProductPrice.price}</Link>
                    ) : (
                      ''
                    )}
                  </td>
                  <td>{unit.product ? <Link to={`product/${unit.product.id}`}>{unit.product.name}</Link> : ''}</td>
