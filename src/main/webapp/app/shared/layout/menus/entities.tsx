...
export const EntitiesMenu = props => (
  ...
  >
    ...
    <MenuItem icon="asterisk" to="/price-history">
      <Translate contentKey="global.menu.entities.priceHistory" />
    </MenuItem>
    <MenuItem icon="asterisk" to="/unit-equivalence">
      <Translate contentKey="global.menu.entities.unitEquivalence" />
    </MenuItem>
