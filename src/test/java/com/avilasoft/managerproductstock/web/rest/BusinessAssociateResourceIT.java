...
class BusinessAssociateResourceIT {
    ...
    void createBusinessAssociate() throws Exception {
        ...
        assertThat(testBusinessAssociate.getNickname()).isEqualTo(DEFAULT_NICKNAME);
        assertThat(testBusinessAssociate.getName()).isEqualTo(DEFAULT_NAME);
        assertThat(testBusinessAssociate.getLastname()).isEqualTo(DEFAULT_LASTNAME);
    ...
    void checkNicknameIsRequired() throws Exception {
        ...
        // set the field null
        businessAssociate.setNickname(null);
    ...
    void checkLastnameIsRequired() throws Exception {
        int databaseSizeBeforeTest = businessAssociateRepository.findAll().size();
        // set the field null
        businessAssociate.setLastname(null);
    ...
    void putNewBusinessAssociate() throws Exception {
        ...
        BusinessAssociate testBusinessAssociate = businessAssociateList.get(businessAssociateList.size() - 1);
        assertThat(testBusinessAssociate.getNickname()).isEqualTo(UPDATED_NICKNAME);
        assertThat(testBusinessAssociate.getName()).isEqualTo(UPDATED_NAME);
        assertThat(testBusinessAssociate.getLastname()).isEqualTo(UPDATED_LASTNAME);
