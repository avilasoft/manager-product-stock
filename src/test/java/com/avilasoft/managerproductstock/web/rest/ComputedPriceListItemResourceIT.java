...
class ComputedPriceListItemResourceIT {
    ...
    private static final Float DEFAULT_COMPUTED_COST_TOTAL = 1F;
    private static final Float UPDATED_COMPUTED_COST_TOTAL = 2F;
    ...
    public static ComputedPriceListItem createEntity(EntityManager em) {
        ComputedPriceListItem computedPriceListItem = new ComputedPriceListItem()
            .code(DEFAULT_CODE)
            .name(DEFAULT_NAME)
            .computedCostTotal(DEFAULT_COMPUTED_COST_TOTAL)
    ...
    public static ComputedPriceListItem createUpdatedEntity(EntityManager em) {
        ComputedPriceListItem computedPriceListItem = new ComputedPriceListItem()
            .code(UPDATED_CODE)
            .name(UPDATED_NAME)
            .computedCostTotal(UPDATED_COMPUTED_COST_TOTAL)
    ...
    void createComputedPriceListItem() throws Exception {
        ...
        assertThat(testComputedPriceListItem.getName()).isEqualTo(DEFAULT_NAME);
        assertThat(testComputedPriceListItem.getComputedCostTotal()).isEqualTo(DEFAULT_COMPUTED_COST_TOTAL);
    ...
    @Test
    @Transactional
    void checkComputedCostTotalIsRequired() throws Exception {
        int databaseSizeBeforeTest = computedPriceListItemRepository.findAll().size();
        // set the field null
        computedPriceListItem.setComputedCostTotal(null);
    ...
    void getAllComputedPriceListItems() throws Exception {
        ...
        restComputedPriceListItemMockMvc
            ...
            .andExpect(jsonPath("$.[*].computedCostTotal").value(hasItem(DEFAULT_COMPUTED_COST_TOTAL.doubleValue())))
    ...
    void getComputedPriceListItem() throws Exception {
        ...
        restComputedPriceListItemMockMvc
            ...
            .andExpect(jsonPath("$.computedCostTotal").value(DEFAULT_COMPUTED_COST_TOTAL.doubleValue()))
    ...
    void putNewComputedPriceListItem() throws Exception {
        ...
        assertThat(testComputedPriceListItem.getName()).isEqualTo(UPDATED_NAME);
        assertThat(testComputedPriceListItem.getComputedCostTotal()).isEqualTo(UPDATED_COMPUTED_COST_TOTAL);
    ...
    void partialUpdateComputedPriceListItemWithPatch() throws Exception {
        ...
        partialUpdatedComputedPriceListItem.code(UPDATED_CODE).name(UPDATED_NAME).computedQuantityTotal(UPDATED_COMPUTED_QUANTITY_TOTAL);
