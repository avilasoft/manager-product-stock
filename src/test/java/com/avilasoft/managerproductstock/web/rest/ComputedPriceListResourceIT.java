...
class ComputedPriceListResourceIT {
    ...
    void createComputedPriceList() throws Exception {
        ...
        assertThat(testComputedPriceList.getDescription()).isEqualTo(DEFAULT_DESCRIPTION);
    }
    ...
    @Test
    @Transactional
    void checkComputedPriceListTotalIsRequired() throws Exception {
        int databaseSizeBeforeTest = computedPriceListRepository.findAll().size();
        // set the field null
        computedPriceList.setComputedPriceListTotal(null);
    ...
    void putNewComputedPriceList() throws Exception {
        ...
        assertThat(testComputedPriceList.getDescription()).isEqualTo(UPDATED_DESCRIPTION);
    }
    ...
    void partialUpdateComputedPriceListWithPatch() throws Exception {
        ...
        partialUpdatedComputedPriceList.code(UPDATED_CODE).description(UPDATED_DESCRIPTION);
    ...
    void fullUpdateComputedPriceListWithPatch() throws Exception {
        ...
        partialUpdatedComputedPriceList
            .code(UPDATED_CODE)
            .computedPriceListTotal(UPDATED_COMPUTED_PRICE_LIST_TOTAL)
            .description(UPDATED_DESCRIPTION);
