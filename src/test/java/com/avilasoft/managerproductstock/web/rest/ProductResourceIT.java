...
import com.avilasoft.managerproductstock.repository.ProductRepository;
...
class ProductResourceIT {
    ...
    public static Product createEntity(EntityManager em) {
        ...
        product.getProviderProducts().add(providerProduct);
        // Add required entity
    ...
    void createProduct() throws Exception {
        ...
        assertThat(testProduct.getItem()).isEqualTo(DEFAULT_ITEM);
    ...
    void putNewProduct() throws Exception {
        ...
        Product testProduct = productList.get(productList.size() - 1);
        assertThat(testProduct.getItem()).isEqualTo(UPDATED_ITEM);
