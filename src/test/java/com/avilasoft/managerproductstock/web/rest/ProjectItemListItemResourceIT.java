...
class ProjectItemListItemResourceIT {
    ...
    void createProjectItemListItem() throws Exception {
        ...
        assertThat(testProjectItemListItem.getName()).isEqualTo(DEFAULT_NAME);
    ...
    void checkNameIsRequired() throws Exception {
        ...
        // set the field null
        projectItemListItem.setName(null);
    ...
    void putNewProjectItemListItem() throws Exception {
        ...
        updatedProjectItemListItem.code(UPDATED_CODE).name(UPDATED_NAME).dimension(UPDATED_DIMENSION).quantity(UPDATED_QUANTITY);
        ...
        assertThat(testProjectItemListItem.getName()).isEqualTo(UPDATED_NAME);
    ...
    void partialUpdateProjectItemListItemWithPatch() throws Exception {
        ...
        partialUpdatedProjectItemListItem.name(UPDATED_NAME);
    ...
    void fullUpdateProjectItemListItemWithPatch() throws Exception {
        ...
        partialUpdatedProjectItemListItem.code(UPDATED_CODE).name(UPDATED_NAME).dimension(UPDATED_DIMENSION).quantity(UPDATED_QUANTITY);
