...
import com.avilasoft.managerproductstock.repository.ProjectRepository;
...
class ProjectResourceIT {
    ...
    private static final ProjectType DEFAULT_TYPE = ProjectType.RED_AGUA_POTABLE;
    private static final ProjectType UPDATED_TYPE = ProjectType.CLOACAS;
    ...
    public static Project createEntity(EntityManager em) {
        Project project = new Project().name(DEFAULT_NAME).type(DEFAULT_TYPE);
        // Add required entity
        ...
        project.setBusinessAssociate(businessAssociate);
        // Add required entity
        ProjectGroup projectGroup;
        if (TestUtil.findAll(em, ProjectGroup.class).isEmpty()) {
            projectGroup = ProjectGroupResourceIT.createEntity(em);
            em.persist(projectGroup);
            em.flush();
        } else {
            projectGroup = TestUtil.findAll(em, ProjectGroup.class).get(0);
        }
    ...
    public static Project createUpdatedEntity(EntityManager em) {
        Project project = new Project().name(UPDATED_NAME).type(UPDATED_TYPE);
        // Add required entity
        BusinessAssociate businessAssociate;
        if (TestUtil.findAll(em, BusinessAssociate.class).isEmpty()) {
        ...
        ProjectGroup projectGroup;
        if (TestUtil.findAll(em, ProjectGroup.class).isEmpty()) {
            projectGroup = ProjectGroupResourceIT.createUpdatedEntity(em);
            em.persist(projectGroup);
            em.flush();
        } else {
            projectGroup = TestUtil.findAll(em, ProjectGroup.class).get(0);
    ...
    void putNewProject() throws Exception {
        ...
        updatedProject.name(UPDATED_NAME).type(UPDATED_TYPE);
    ...
    void fullUpdateProjectWithPatch() throws Exception {
        ...
        partialUpdatedProject.name(UPDATED_NAME).type(UPDATED_TYPE);
