...
class ProviderItemResourceIT {
    ...
    public static ProviderItem createEntity(EntityManager em) {
        ProviderItem providerItem = new ProviderItem().name(DEFAULT_NAME).description(DEFAULT_DESCRIPTION).cost(DEFAULT_COST);
        // Add required entity
        Provider provider;
    ...
    public static ProviderItem createUpdatedEntity(EntityManager em) {
        ProviderItem providerItem = new ProviderItem().name(UPDATED_NAME).description(UPDATED_DESCRIPTION).cost(UPDATED_COST);
        // Add required entity
        Provider provider;
        if (TestUtil.findAll(em, Provider.class).isEmpty()) {
    ...
    void createProviderItem() throws Exception {
        ...
        assertThat(testProviderItem.getName()).isEqualTo(DEFAULT_NAME);
    ...
    void putNewProviderItem() throws Exception {
        ...
        updatedProviderItem.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).cost(UPDATED_COST);
        ...
        ProviderItem testProviderItem = providerItemList.get(providerItemList.size() - 1);
        assertThat(testProviderItem.getName()).isEqualTo(UPDATED_NAME);
    ...
    void partialUpdateProviderItemWithPatch() throws Exception {
        ...
        partialUpdatedProviderItem.name(UPDATED_NAME).description(UPDATED_DESCRIPTION);
    ...
    void fullUpdateProviderItemWithPatch() throws Exception {
        ...
        partialUpdatedProviderItem.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).cost(UPDATED_COST);
