...
class ProviderProductPriceResourceIT {
    ...
    public static ProviderProductPrice createEntity(EntityManager em) {
        ProviderProductPrice providerProductPrice = new ProviderProductPrice().price(DEFAULT_PRICE);
        // Add required entity
        ProviderProduct providerProduct;
        if (TestUtil.findAll(em, ProviderProduct.class).isEmpty()) {
            providerProduct = ProviderProductResourceIT.createEntity(em);
            em.persist(providerProduct);
            em.flush();
        } else {
            providerProduct = TestUtil.findAll(em, ProviderProduct.class).get(0);
        }
        providerProductPrice.setProviderProduct(providerProduct);
        // Add required entity
        Unit unit;
        ...
        providerProductPrice.getUnits().add(unit);
    ...
    public static ProviderProductPrice createUpdatedEntity(EntityManager em) {
        ProviderProductPrice providerProductPrice = new ProviderProductPrice().price(UPDATED_PRICE);
        // Add required entity
        ProviderProduct providerProduct;
        if (TestUtil.findAll(em, ProviderProduct.class).isEmpty()) {
            providerProduct = ProviderProductResourceIT.createUpdatedEntity(em);
            em.persist(providerProduct);
            em.flush();
        } else {
            providerProduct = TestUtil.findAll(em, ProviderProduct.class).get(0);
    ...
    void createProviderProductPrice() throws Exception {
        ...
        assertThat(testProviderProductPrice.getPrice()).isEqualByComparingTo(DEFAULT_PRICE);
    }
    ...
    void putNewProviderProductPrice() throws Exception {
        ...
        updatedProviderProductPrice.price(UPDATED_PRICE);
        ...
        ProviderProductPrice testProviderProductPrice = providerProductPriceList.get(providerProductPriceList.size() - 1);
        assertThat(testProviderProductPrice.getPrice()).isEqualByComparingTo(UPDATED_PRICE);
    }
    ...
    void fullUpdateProviderProductPriceWithPatch() throws Exception {
        ...
        partialUpdatedProviderProductPrice.price(UPDATED_PRICE);
