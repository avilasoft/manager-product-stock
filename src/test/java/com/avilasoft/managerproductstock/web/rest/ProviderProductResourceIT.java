...
class ProviderProductResourceIT {
    ...
    public static ProviderProduct createEntity(EntityManager em) {
        ...
        // Add required entity
        ProviderProductPrice providerProductPrice;
        if (TestUtil.findAll(em, ProviderProductPrice.class).isEmpty()) {
            providerProductPrice = ProviderProductPriceResourceIT.createEntity(em);
            em.persist(providerProductPrice);
            em.flush();
        } else {
            providerProductPrice = TestUtil.findAll(em, ProviderProductPrice.class).get(0);
        }
        providerProduct.setProviderProductPrice(providerProductPrice);
        // Add required entity
        Product product;
    ...
    public static ProviderProduct createUpdatedEntity(EntityManager em) {
        ...
        ProviderProductPrice providerProductPrice;
        if (TestUtil.findAll(em, ProviderProductPrice.class).isEmpty()) {
            providerProductPrice = ProviderProductPriceResourceIT.createUpdatedEntity(em);
            em.persist(providerProductPrice);
            em.flush();
        } else {
            providerProductPrice = TestUtil.findAll(em, ProviderProductPrice.class).get(0);
