...
class UnitPriceListResourceIT {
    ...
    public static UnitPriceList createEntity(EntityManager em) {
        UnitPriceList unitPriceList = new UnitPriceList()
            .code(DEFAULT_CODE)
            .unitPriceListTotal(DEFAULT_UNIT_PRICE_LIST_TOTAL)
    ...
    public static UnitPriceList createUpdatedEntity(EntityManager em) {
        UnitPriceList unitPriceList = new UnitPriceList()
            .code(UPDATED_CODE)
            .unitPriceListTotal(UPDATED_UNIT_PRICE_LIST_TOTAL)
    ...
    void createUnitPriceList() throws Exception {
        ...
        assertThat(testUnitPriceList.getDescription()).isEqualTo(DEFAULT_DESCRIPTION);
    }
    ...
    @Test
    @Transactional
    void checkUnitPriceListTotalIsRequired() throws Exception {
        int databaseSizeBeforeTest = unitPriceListRepository.findAll().size();
        // set the field null
        unitPriceList.setUnitPriceListTotal(null);
    ...
    void putNewUnitPriceList() throws Exception {
        ...
        updatedUnitPriceList.code(UPDATED_CODE).unitPriceListTotal(UPDATED_UNIT_PRICE_LIST_TOTAL).description(UPDATED_DESCRIPTION);
        ...
        assertThat(testUnitPriceList.getDescription()).isEqualTo(UPDATED_DESCRIPTION);
    }
    ...
    void fullUpdateUnitPriceListWithPatch() throws Exception {
        ...
        partialUpdatedUnitPriceList.code(UPDATED_CODE).unitPriceListTotal(UPDATED_UNIT_PRICE_LIST_TOTAL).description(UPDATED_DESCRIPTION);
